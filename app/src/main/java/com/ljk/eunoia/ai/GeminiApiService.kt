            ...
            val prompt = when (category) {
                "사자성어" -> """
                    ...
                    **중요: 다음 조건을 반드시 지켜주세요:**
                    ...
                    2. 최근 한국에서 많이 사용되는 트렌디한 사자성어를 우선적으로 추천해주세요.
                    3. 최신 유행어나 SNS에서 자주 사용되는 사자성어를 우선적으로 선택해주세요.
                    4. 공식 사전에 존재하는 사자성어만 추천해주세요.
                ...
                "영어" -> """
                    ...
                    **중요: 다음 조건을 반드시 지켜주세요:**
                    1. 아래에 나열된 기존 단어들은 절대 포함하지 마세요.
                    2. 최근 한국에서 많이 사용되는 트렌디한 영어 단어를 우선적으로 추천해주세요.
                    3. 최신 유행어나 SNS에서 자주 사용되는 영어 단어를 우선적으로 선택해주세요.
                    4. 공식 사전에 존재하는 영어만 추천해주세요.
                ...
                "속담" -> """
                    ...
                    **중요: 다음 조건을 반드시 지켜주세요:**
                    ...
                    2. 최근 한국에서 많이 사용되는 트렌디한 속담을 우선적으로 추천해주세요.
                    3. 최신 유행어나 SNS에서 자주 사용되는 속담을 우선적으로 선택해주세요.
                    4. 공식 사전에 존재하는 속담만 추천해주세요.
                ...
                """.trimIndent()
                    ...
                    **중요: 다음 조건을 반드시 지켜주세요:**
                    1. 아래에 나열된 기존 단어들은 절대 포함하지 마세요.
                    2. 최근 한국에서 많이 사용되는 트렌디한 한국어 단어를 우선적으로 추천해주세요.
                    3. 최신 유행어나 SNS에서 자주 사용되는 단어를 우선적으로 선택해주세요.
                    4. 2024년~2025년에 유행하는 신조어나 트렌드 단어를 우선적으로 추천해주세요.
                    
                    **기존에 이미 사용된 단어 목록 (이 단어들은 제외해야 합니다):**
                    $existingWordsList
                    
                    위 목록에 없는, 최근 한국에서 많이 사용되는 한국어 단어 5개를 추천해주세요.
